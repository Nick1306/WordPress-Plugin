...
Plugin URI:  https://github.com/Nick1306/WordPress-Plugin
Description: The purpose of this plugin is to allow users to create a pop-up window(s) that will appear when a user visits other site. The number of times that these can load is configurable. They can load content from external sites or text .
Version:     1.0
Author:      Nikunj Bhatt
Author URI:  https://github.com/Nick1306/
License:     GPL2 
*/
